...
const envSchema = z.object({
  ...
  AUDIO_COMMAND_ALLOWLIST: z.string().default("help,ping,agenda,status,task,note,reminder,timer,calc,sticker,toimg,rnfig,tts,search,google,search-ai,sai,img,gimage,dl"),
  ...
  IMAGE_SEARCH_PROVIDER: z.enum(["google", "wikimedia"]).default("google"),
