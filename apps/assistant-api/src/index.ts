...
import { createAssistantApiRuntime } from "./bootstrap/runtime.js";
import { reportStartupStatus } from "./bootstrap/startup-status.js";
import { registerAssistantApiRoutes } from "./http/routes.js";

const runtime = createAssistantApiRuntime();
...
registerAssistantApiRoutes(app, runtime);
