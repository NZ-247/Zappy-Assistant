...
import type { AdminApiRuntime } from "./runtime.js";
...
export const checkRedisHealth = async (runtime: Pick<AdminApiRuntime, "redis">): Promise<boolean> =>
  runtime.redis
    .ping()
    .then(() => true)
    .catch(() => false);

export const reportStartupStatus = async (runtime: Pick<AdminApiRuntime, "logger" | "redis">): Promise<void> => {
